exports.up = async function (knex) {
    ...
    await knex.raw(`
        CREATE OR REPLACE FUNCTION update_modified_events_column()
        RETURNS TRIGGER AS $$
        BEGIN
            NEW.updated_at = NOW();
            RETURN NEW;
    ...
    await knex.raw(`
        ...
        FOR EACH ROW EXECUTE FUNCTION update_modified_events_column();
    `);
};
...
exports.down = async function (knex) {
    ...
    await knex.raw(`DROP FUNCTION IF EXISTS update_modified_events_column`);
};
